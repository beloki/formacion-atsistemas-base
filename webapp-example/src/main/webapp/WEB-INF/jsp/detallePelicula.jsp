		...
		<div class="row">
			...
			<form:form id="formularioPelicula" method="post"
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<form:errors path="titulo" cssClass="control-label" cssStyle="color: red;"/>
					</div>
					<div class="col-sm-8">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<form:errors path="director" cssClass="control-label" cssStyle="color: red;"/>
					</div>
					<div class="col-sm-8">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<form:errors path="genero" cssClass="control-label" cssStyle="color: red;"/>
					</div>
					<div class="col-sm-8">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<form:errors path="fechaEstreno" cssClass="control-label" cssStyle="color: red;"/>
					</div>
					<div class="col-sm-8">
